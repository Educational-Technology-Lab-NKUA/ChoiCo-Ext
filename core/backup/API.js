function setUpCommunication(gameInstance)
{
	...
	//register this component as [choico] with wiil
	...
	wiil.pushFunction
	(
		"getState", // the function returns the state of the choico instance as a JSON object
		function()
		{
			console.log(">>> getting state");
			console.log(choicoWidget.getState());
	...
	{   //sends the current state to host. It is called when the button "save online" is clicked by the teacher
		...
		var currentState = choicoWidget.getState();			//get state from choico game (plamyMode.jse)
